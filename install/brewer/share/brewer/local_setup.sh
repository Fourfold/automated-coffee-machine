...
: ${AMENT_CURRENT_PREFIX:="/home/fourfold/dev/inmind sessions/inmind-session-12/automated-coffee-machine/install/brewer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brewer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brewer/environment/path.sh"
